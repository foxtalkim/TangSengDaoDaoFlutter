...
class UnsupportedPacket extends Packet {
  UnsupportedPacket(PacketHeader header) {
    this.header = header;
  }
}
...
class ConnectPacket extends Packet {
  ...
  @override
  String toString() {
    return "version:$version，clientKey：$clientKey，deviceID：$deviceID，deviceFlag：$deviceFlag，clientTimestamp:$clientTimestamp，uid：$uid，tokenLen：${token.length}";
  }
}
...
class EventPacket extends Packet {
  ...
  @override
  String toString() {
    return "id:$id，type:$type，timestamp:$timestamp，data:$data";
  }
}
